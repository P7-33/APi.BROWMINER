...
+ [Dashboard endpoints](#link_M2) (Retrieve information about various entities in a neat format from our databases)
  + [Bitcoin, Bitcoin Cash, Litecoin, Bitcoin SV, Dogecoin, Dash, Groestlcoin, Zcash, and Bitcoin Testnet](#link_M21)
      - [Block](#link_100)
...
## <a name="link_009"></a> Tezos-like blockchain stats
...
### <a name="link_501"></a> Omni Layer property info
...
## <a name="link_M39"></a> Raw data endpoints for Tezos



### <a name="link_112"></a> Raw block data
...
### <a name="link_213"></a> Raw operation data
...
### <a name="link_308"></a> Raw account data
...
### <a name="link_502"></a> `properties` table (Omni Layer)
...
- https://.com/tools/release-monitor
...
- `https://api..com/{:chain}/dashboards/transaction/{:hash}₀?privacy-o-meter=true`
- `https://api..com/{:chain}/dashboards/transactions/{:hash}₀,...,{:hash}ᵩ?privacy-o-meter=true` (up to 10 transactions, comma-separated)
...
Not only  API provides you with blockchain data, but also with some crypto news to integrate into your app. We're aggregating data from more than 60 news outlets in 14 languages, populating over 35,000 headlines into our database a month,. 
...
| hash           | `[0-9a-f]{10}`                  | Internal  hash (unique id)                         | `=`  |      |      |      |
| file           | `string`                        | Internal  article name                             |      |      |      |      |
| permalink      | `string` (URL)                  | URL to the article on .com                         |      |      |      |      |

Default sorting is by `tim`e descending.

**Some examples:** 

* The latest crypto news in English: `https://api..com/news?q=language(en)`
* Find news about : `https://api..com/news?q=title(~),or,description(~)`
  ...
  "data": [
    {
      ...
      "permalink": "https://.com/en/news/ten-days-remain-where-buying-bitcoin-was-unprofitable--cbe09bd89c"
    },
    ...
  ],
  "context": {
...
**Explore how this functionality works on : https://.com/news** (try to switch languages as well!)
